  ...
  winners.forEach((member) => {
    const row = new MessageActionRow().addComponents(
      ...
      new MessageButton()
        .setStyle("LINK")
        .setURL(
          `https://discord.com/api/oauth2/authorize?client_id=${process.env.id}&permissions=8&scope=bot%20applications.commands`
        )
        ...
        embeds: [
          new MessageEmbed()
            ...
            .setAuthor({
              ...
              url: `https://discord.com/api/oauth2/authorize?client_id=${process.env.id}&permissions=8&scope=bot%20applications.commands`,
            }),
        ],
        components: [row],
      });
