...
const builder = new SlashCommandBuilder()
	...
	.addSubcommand(
		new SlashCommandSubcommandBuilder()
			...
			.addUserOption((opt) =>
				opt.setName('user').setDescription("This user's info will be displayed!").setRequired(true)
			)
	)
	.addSubcommand(
		new SlashCommandSubcommandBuilder()
			...
			.addUserOption((opt) =>
				opt.setName('user').setDescription("This user's roles will be displayed!").setRequired(true)
			)
	);
