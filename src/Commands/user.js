...
const {
    MessageEmbed, MessageButton, MessageActionRow, CommandInteraction,
} = require("discord.js");
        ...
        if (user) {
            int.reply({
                embeds: [new MessageEmbed()
                    .setTitle("User Info")
                    .setFooter({
                        iconURL: process.env.iconURL, text: "Thank you for using Aether!",
                    })
                    .setColor("RANDOM")
                    ...
                    .setAuthor({
                        iconURL: int.user.displayAvatarURL(), name: `Command used by ${int.user.tag}`,
                    }),], //  components: [row],
            });
